...
var reducer = function (state, action) {
    switch (action.type) {
        case "MAP_CHANGED":
            return __assign(__assign({}, state), { map: action.payload });
        case "VIEW_CHANGED":
            return __assign(__assign({}, state), { view: action.payload });
        case "SUBSCRIPTION_ADDED":
            return __assign(__assign({}, state), { subscriptions: __assign(__assign({}, state.subscriptions), action.payload) });
        ...
        case "MAP_RENDERED_CHANGED":
            return __assign(__assign({}, state), { rendered: action.payload });
        default:
            return state;
    }
};
...
var MapContext = react_1.default.createContext(initialState);
exports.MapContext = MapContext;
var MapProvider = function (_a) {
    var children = _a.children;
    var _b = react_1.useReducer(reducer, initialState), state = _b[0], dispatch = _b[1];
    var updateMap = function (map) { return dispatch({ type: "MAP_CHANGED", payload: map }); };
    var updateView = function (view) { return dispatch({ type: "VIEW_CHANGED", payload: view }); };
    ...
    react_1.useEffect(function () {
        var asyncEffect = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loadModules(['esri/core/watchUtils'])];
                    case 1:
                        watchUtils = (_a.sent())[0];
    ...
    return (react_1.default.createElement(MapContext.Provider, { value: value }, children));
};
