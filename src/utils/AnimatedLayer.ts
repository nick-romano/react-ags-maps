...
export class CustomLayerView2D extends BaseLayerViewGL2D {
    aPosition: number = 0;
    aOffset: number = 1;
    transform: mat3;
    ...
    screenScaling: vec3;
    needsUpdate: boolean;
    watcher: __esri.WatchHandle;
    program: WebGLProgram | null = null;
    uTransform: WebGLUniformLocation | null = null;
    uDisplay: WebGLUniformLocation | null = null;
    uCurrentTime: WebGLUniformLocation | null = null;
    vertexBuffer: WebGLBuffer | null = null;
    indexBuffer: WebGLBuffer | null = null;
    indexBufferSize: number | null = null;
    centerAtLastUpdate: vec2 | null = null;


    constructor({layer, view}: { layer: __esri.GraphicsLayer, view: __esri.View }) {
        super()
    ...
    attach(): void {
        var gl: WebGL2RenderingContext = this.context;
    ...
    updatePositions(renderParameters: any) {
        var gl = renderParameters.context;
        ...
        this.centerAtLastUpdate = state.center;
        this.translationToCenter[0] = 0;
        this.translationToCenter[1] = 0;
        this.needsUpdate = false;
...
export class AnimatedLayer extends GraphicsLayer {
    async createLayerView(view: any, options?: __esri.LayerCreateLayerViewOptions | undefined): Promise<__esri.LayerView> {
